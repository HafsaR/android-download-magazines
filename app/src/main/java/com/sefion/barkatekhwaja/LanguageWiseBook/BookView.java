...
import com.sefion.barkatekhwaja.LanguageWiseBook.Adapter;
import com.sefion.barkatekhwaja.IslamicBookView.Data;
...
public class BookView extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        URL_DATA = "http://barkatekhwaja.net/index.php?app/bookslw/" + value + "/S51bkiwmIsMYAmk8Ts";
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                count = count + 1;
                                LanguageData data = new LanguageData(o.getString("image_link"), o.getString("doc_link"), o.getString("name"), o.getString("author"), o.getString("editor"),
                            ...
                            adapter = new Adapter(getActivity(), languageData);
