...
import com.sefion.barkatekhwaja.IslamicBookView.Adapter;
import com.sefion.barkatekhwaja.IslamicBookView.BookView;
...
public class Books extends Fragment {
    ...
    List<com.sefion.barkatekhwaja.IslamicBookView.BookData> islamicBookData;
    Adapter islamicAdapter;

    TextView bookid;
    private static final String URL_DATA = "http://barkatekhwaja.net/?app/section/S51bkiwmIsMYAmk8Ts";
    private static final String SB_DATA_URL = "http://barkatekhwaja.net/?app/nosb/S51bkiwmIsMYAmk8Ts";

    private static final String SEARCH_URL = "http://barkatekhwaja.net/index.php?app/books/all/S51bkiwmIsMYAmk8Ts";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        search = (EditText) view.findViewById(R.id.searchB);
        ...
        search.addTextChangedListener(new TextWatcher() {
            ...
            private void filter(String text) {
                ArrayList<com.sefion.barkatekhwaja.IslamicBookView.BookData> filteredBooks = new ArrayList<>();
                for (com.sefion.barkatekhwaja.IslamicBookView.BookData s : islamicBookData) {
                    if (s.getSubject().toString().toLowerCase().contains(text.toLowerCase())) {
                        filteredBooks.add(s);
                    }
                }
                islamicAdapter.filterList(filteredBooks);
            }
        });
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                BookData bData = new BookData(o.getString("name"),
                                        o.getString("name_guj"), o.getString("num_of_books")
        ...
        StringRequest sRequest = new StringRequest(Request.Method.GET,
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            JSONObject jsonObject = new JSONObject(response);
                            JSONArray array = jsonObject.getJSONArray("nosb");
                            // for (int i = 0; i < array.length(); i++) {
                            JSONObject o = array.getJSONObject(0);
                            String sec = o.getString("num_of_sections");
                            String b = o.getString("num_of_book");


                            Sections.setText(sec + " Section");
                            Books.setText(b);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                JSONObject o = array.getJSONObject(i);
                                com.sefion.barkatekhwaja.IslamicBookView.BookData data = new com.sefion.barkatekhwaja.IslamicBookView.BookData(o.getString("image_link"), o.getString("doc_link"), o.getString("name"), o.getString("author"), o.getString("editor"),
                                ...
                                islamicBookData.add(data);

                            }


                            islamicAdapter = new Adapter(getActivity(), islamicBookData);
