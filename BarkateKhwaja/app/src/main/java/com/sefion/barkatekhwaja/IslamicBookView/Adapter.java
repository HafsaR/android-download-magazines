...
import com.sefion.barkatekhwaja.OnLoadMoreListener;
...
public class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder> {
    ...
    public Adapter(Context context, List<BookData> datas) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (holder instanceof MyViewHolder) {
            ...
            final BookData current = datas.get(position);
...
//                        i.putExtra(Intent.EXTRA_TEXT, more);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView subject;
        TextView author;
        TextView editor, translator, section, language, pagenumber;
